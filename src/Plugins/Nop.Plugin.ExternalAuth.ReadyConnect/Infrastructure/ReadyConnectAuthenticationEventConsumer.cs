...
{
    /// <summary>
    /// ReadyConnect authentication event consumer (used for saving customer fields on registration)
    /// </summary>
    public partial class ReadyConnectAuthenticationEventConsumer : IConsumer<CustomerAutoRegisteredByExternalMethodEvent>
    {
        #region Fields
        ...
        public ReadyConnectAuthenticationEventConsumer(IGenericAttributeService genericAttributeService)
        {
        ...
        public void HandleEvent(CustomerAutoRegisteredByExternalMethodEvent eventMessage)
        {
            ...
            if (!eventMessage.AuthenticationParameters.ProviderSystemName.Equals(ReadyConnectAuthenticationDefaults.SystemName))
                return;
